...
<?oracle-xsl-mapper
  ...
  <!-- GENERATED BY ORACLE XSL MAPPER 11.1.1.7.0(build 140919.1004.0161) AT [SAT MAR 07 12:20:35 IST 2015]. -->
?>
<xsl:stylesheet version="1.0" xmlns:ns1="http://xmlns.oracle.com/ns/fulfillment"
                ...
                exclude-result-prefixes="xsi xsl tns inp1 xsd wsdl ns1 plnk client xp20 bpws mhdr bpel oraext dvm hwf med ids bpm xdk xref ora socket ldap">
  <xsl:template match="/">
    <ns1:Fulfillment>
      <ns1:total>
